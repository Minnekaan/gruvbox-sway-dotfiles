...
#пакеты шрифтов
# ttf-nerd-fonts-symbols ttf-jetbrains-mono gnu-free-fonts noto-fonts ttf-bitstream-vera fish ttf-croscore ttf-dejavu ttf-droid ttf-ibm-plex ttf-input ttf-input-nerd ttf-liberation ttf-roboto ttf-linux-libertine  ttf-indic-otf
